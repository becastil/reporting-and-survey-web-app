...
const config: Config = {
  ...
  theme: {
    ...
    extend: {
      colors: {
        // Assured Partners Brand Colors
        brand: {
          primary: '#003D7A',      // Assured Partners Blue
          secondary: '#0066CC',    // Interactive Blue
          dark: '#002850',         // Darker blue for hover states
        ...
        variance: {
          positive: '#00A86B',     // Green for positive variance
      ...
      boxShadow: {
        ...
        'focus': '0 0 0 3px rgba(0, 61, 122, 0.2)',
        'glow-success': '0 0 20px rgba(0, 168, 107, 0.3)',
